...
%%%%%%%%override Expresseur:\override NoteHead.color = darkslategrey \override Beam.color = darkslategrey \override Flag.color = darkslategrey \override Stem.color = darkslategrey \stemUp
