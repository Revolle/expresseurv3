...
bool basslua_open(const char* fname, const char* fusername, const char* param, bool reset, long datefname, voidcallback fcallback , const char *logpath, const char *ressourdir, bool external_timer , int timerDt);
