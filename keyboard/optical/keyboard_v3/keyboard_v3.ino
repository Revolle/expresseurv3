...
uint8_t opticalPin[opticalNb] = { A2 , A3 , A4 , A5 } ; // analog pins for the optical button
  ...
  // keep alive led
    if ( calibrationState == 0)
    {
      ...
      if ( since > 805 )
      {
        ...
        //delay(200);
        //potarV0 = adc->adc0->readSingle();
        //potarV1 = adc->adc1->readSingle();
        //potarV1 = analogRead(potarPin1);
        potarAdcPreset() ;
        delay(200);
        potarProcess() ;
