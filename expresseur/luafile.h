...
public:
	...
	wxLongLong time ; 
	int nr_device; int type_msg; int channel; int value1; int value2 ; 
...
public:
	...
	static bool isCalledback(wxLongLong *time , int *nr_device , int *type_msg , int *channel , int *value1 , int *value2 , bool *isProcessed );
